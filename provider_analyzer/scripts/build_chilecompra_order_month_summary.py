...
def choose_event_date(row: dict, mapping: dict) -> tuple[str, str, int]:
    ...
    The source month is the sent-order month. This lifecycle date is kept separately
    and must never be used as the archive/source partition.
    """
